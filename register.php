...
<div class="container" >
  <div class="row">
  	<div class="col-md-6">
          ...
          <form class="form-horizontal"   action="register1.php" method="post" enctype="multipart/form-data">
          <fieldset>
            <div id="legend">
         ...
         <br>
            ...
            <div class="control-group">
              <!-- Button -->
              <div class="controls">
                <button class="btn btn-success" name="login" value="login">Next</button>
              </div>
            </div>
