  	...
  	<div class="col-md-6">
          ...
          <fieldset>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="username" name="username" placeholder="Incorrect AdminName !!" class="form-control input-lg" required >
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="password" id="password" name="password" placeholder="Incorrect Password !!" class="form-control input-lg" required >
              </div>
            </div>
         <br>
