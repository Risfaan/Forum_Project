    ...
    <div class="row profile">
		...
		<div class="col-md-9">
			<div class="profile-content">
			   <h4>Add Semister : </h4></center>
						<br>
                        <br>
       <form name="f1" action="add_sem3.php" method="post">
       		<div class="control-group">
                       		<label class="control-label" for="username">Course Name :</label>
              				<div class="controls">
                <input type="text" name="c" class="form-control input-lg"  style="width:300" value=<?php echo $_POST['course'];?> readonly >
              </div>
              
       <label for="sel1">Add Semisters :</label>
              
                <ul class="list-group">
                	<?php		
							    include("../connection/connect.php");
						
								$q="select * from ".$_POST["course"];
			  ...
			  <label class="control-label" for="username">Enter Total No of Semesters :</label>
              <div class="controls">
