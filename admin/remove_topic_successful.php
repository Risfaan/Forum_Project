...
<div class="container">
    <div class="row profile">
		...
		<div class="col-md-9">
				<center><font color="#00FF00" ><h5>Topic Successfully Removed</h5></font></center>
								...
								if(mysqli_affected_rows($conn)>0)
								{
										...
										while($row = mysqli_fetch_assoc($result)) 
										{
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="remove_topic_backend.php?id=<?php echo $row['id'];?>"><span style="color:red" class="fui-cross">  </span> </a></td>
                                             </tr><?php
   									    }
