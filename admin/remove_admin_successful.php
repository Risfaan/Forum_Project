...
<div class="container">
    <div class="row profile">
		...
		<div class="col-md-9">
				<font color="#00FF00"><h4>Admin SuccessFully Removed !!</h4></font>
              <h1>List of Admin :</h1>
                	...
                	<tr>
              		...
              		<tbody>
                    	...
                    	<?php require("../connection/connect.php");
								$q="select uid,username from admin where username !='".$_SESSION['admin_logged']."';";
								...
								if(mysqli_num_rows($result)>0)
								{
										...
										{
											$i=$i+1;
        									?><tr><td><?php echo $i ?></td><td><?php  echo $row['username'];?></td><td><a href="remove_admin_backend.php?id=<?php echo $row['uid'];?>"><span style="color:red" class="fui-cross">  </span> </a></td></tr><?php
   									    }
