                	...
                	<tr>
              		...
              		<tbody>
                    	...
                    	<?php
								...
								$q="select q_id,qname from question;";
								...
								if(mysqli_affected_rows($conn)>0)
								{
										...
										{
											$i=$i+1;
        									?><tr><td><?php echo $i ?></td><td><?php  echo $row['qname'];?></td>
                                            <td><a href="q_reply_admin.php?id=<?php echo $row['q_id']; ?>"><span style="color:green" class="fui-new">  </span> </a></td>
                                            <td><a href="remove_question_backend.php?id=<?php echo $row['q_id'];?>"><span style="color:red" class="fui-cross">  </span>  </a></td></tr><?php
   									    }
