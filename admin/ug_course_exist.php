    ...
    <div class="row profile">
		...
		<div class="col-md-9">
			<div class="profile-content">
			   <h4>Under-Graduate Course Name </h4></center>
						<br>
                        <br>
                        <font color="#FF0000"><h5>Course Already Exist !! </h5></font>
                        <form name="f1" action="ug_add_backend.php" method="post">
       		<div class="control-group">
              <label class="control-label" for="username">Course Name :</label>
              <div class="controls">
                <input type="text" id="course" name="course" placeholder="" class="form-control input-lg"  style="width:300" required >
              </div>
            </div>
