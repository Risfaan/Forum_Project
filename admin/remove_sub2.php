    ...
    <div class="row profile">
		...
		<div class="col-md-9">
			<div class="profile-content">
			   <h4>Remove Subject :</h4></center>
						<br>
                        <br>
                        <form name="f2" action="remove_sub3.php" method="post">
       	<label class="control-label" for="username">Course Name :</label>
              <div class="controls">
                <input type="text" name="course1" class="form-control input-lg"  style="width:300" value=<?php echo $_POST['course'];?> readonly >
              </div>
