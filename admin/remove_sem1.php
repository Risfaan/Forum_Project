...
<div class="container">
    <div class="row profile">
		...
		<div class="col-md-9">
			<div class="profile-content">
			   <h4>Remove Course Name </h4></center>
						<br>
                        <br>
                        <form name="f2" action="remove_sem2.php" method="post">
		...
		<br>
        <font color="#FF0000" ><small> Notice : The Semester which u Select will be Removed Including the Subjects it Contans !!<small></font>
