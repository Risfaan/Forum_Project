    ...
    <div class="row profile">
		...
		<div class="col-md-9">
			<div class="profile-content">
			   <h4>Sem Already Exist !!Please Try Again ! </h4></center>
						<br>
                        <br>
       <form name="f1" action="add_sem1.php" method="post">
       		<div class="control-group">
                       		
       <label for="sel1">Select Program:</label>
      <select name ="program"class="form-control" id="sel1" style="width:200px" >
